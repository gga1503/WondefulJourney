...
<body>
    ...
    <div class="container mt-4 px-0">
        <nav class="navbar navbar-expand-lg navbar-light bg-dark">
            <!-- <a class="navbar-brand text-white" href="{{ url('/admin_panel') }}">Admin</a> -->
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item mx-2">
                        <a href="{{ url('/home_admin') }}" class="nav-link btn btn-dark text-white" type="button">Home</a>
                    </li>
                    <li class="nav-item mx-2">
                        <a href="{{ url('/list_admin') }}" class="nav-link btn btn-dark text-white" type="button">Admin</a>
                    </li>
                    <li class="nav-item mx-2">
                        <a href="{{ url('/list_user') }}" class="nav-link btn btn-dark text-white" type="button">User</a>
                    </li>
                </ul>
            </div>
